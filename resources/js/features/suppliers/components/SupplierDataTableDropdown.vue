<script setup lang="ts">
    ...
    import { ref } from 'vue';
    import { destroy, edit } from '@/actions/App/Http/Controllers/SupplierController';
    import {
        AlertDialog,
        AlertDialogAction,
        AlertDialogCancel,
    ...
    const handleDelete = () => {
        ...
        router.delete(destroy(props.supplier.id), {
            onFinish: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent>
            ...
            <DropdownMenuSeparator />
            <Link :href="edit(supplier.id).url" :method="edit(supplier.id).method">
                <DropdownMenuItem>
        ...
        <AlertDialogContent>
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                    ...
                    product <span class="font-extrabold">{{ supplier.name }}</span> and remove it's data from our
                    servers.
                </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>

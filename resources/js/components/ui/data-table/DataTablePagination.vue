...
<template>
  <div class="flex flex-col sm:flex-row items-center justify-between px-2">
    <div class="flex-1 text-sm text-muted-foreground sm:mr-2">
      {{ table.getFilteredSelectedRowModel().rows.length }} of
      {{ table.getFilteredRowModel().rows.length }} row(s) selected.
    </div>
    <div class="flex flex-col sm:flex-row items-center space-y-2 md:space-y-0 space-x-6 lg:space-x-8">
